                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3">
                                ...
                                <p className="color-white">Av. das Américas 17.150 – Bloco 1 – Sala 525 <br />
                                ...
                                <div className="row">
                                    <div className="col-lg-12 col-sm-6">
                                        <div className="contato-footer">
                                            <img src="./imagens/icone-telefone-footer.png" alt="telefone" />
                                            <span className="color-white">(21) 2496-5644</span>
                                        </div>
                                    </div>

                                    <div className="col-lg-12 col-sm-6">
                                        <div className="contato-footer">
                                            <img src="./imagens/icone-email-footer.png" alt="Facebook" />
                                            <span className="color-white">contato@salud.com.br</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            Ocultar conteudo provisoriamente

                            <div className="col-lg-3 redes-sociais">
                                <h3 className="color-light-blue">Fique conectado com a Salud:</h3>

                                <ul className="navbar-nav">
                                    <li className="nav-item active">
                                    <a className="nav-link" href="#">
                                        <img className="icone-sociais" src="./imagens/icone-facebook.png" alt="Facebook">
                                    </a>
                                    </li>
